...
ui <- fluidPage(
  ...
  p("Please upload the 'preds_corn.rds' file from your local machine."),
  fileInput('preds', label='Click button below to  select the "preds_corn.rds" file on your computer.',
            accept = c('.rds')),
     ...
     tabsetPanel(
      ...
      tabPanel(
        ...
        sidebarPanel(
          ...
          bsTooltip(id = "strat_weight", title = paste0('0: Match 2023 regional distribution of acres', br(),br(), '1: Maximize PPV by placing acres in best regions')),
